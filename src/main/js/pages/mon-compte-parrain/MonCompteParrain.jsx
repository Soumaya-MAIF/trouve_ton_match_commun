...
const MonCompteParrain = () => {
  ...
  const validate = () => {
    ...
    if (!parrainDto.presentationParcours || parrainDto.presentationParcours.trim() === "")
      newErrors.presentationParcours = "La présentation du parcours est requis";
    if (!parrainDto.branchesReseau || parrainDto.branchesReseau.trim() === "") newErrors.branchesReseau = "Le type de réseau est requis";
    if (!parrainDto.domainesExpertise || parrainDto.domainesExpertise.trim() === "")
      newErrors.domainesExpertise = "Le domaine d'expertise est requis";
    if (!parrainDto.secteurGeographique || parrainDto.secteurGeographique.trim() === "")
      newErrors.secteurGeographique = "Le secteur géographique est requis";
    if (!parrainDto.disponibilites || parrainDto.disponibilites.trim() === "")
      newErrors.disponibilites = "Les disponibilités sont requises";
  ...
  const handleSubmit = (e) => {
    ...
    fetch("/creationCompte/completercompteparrain", {
      method: "POST",
      headers: {
