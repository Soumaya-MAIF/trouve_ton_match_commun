...
//
//    @GetMapping("/{id}")
//    public SecteurReseau getSecteursReseauxById(@PathVariable Long id) {
//        return service.getSecteursReseauxById(id).orElse(null);
//    }
//
//
//    @GetMapping("")
//    public List<SecteurReseau> getAll() {
//        List<SecteurReseau> secteurs = service.getSecteursReseaux();
